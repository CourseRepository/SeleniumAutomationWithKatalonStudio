...
//Step - 1  input text to the text box
WebUI.sendKeys(findTestObject('Object Repository/TelerikWebElemet/InputBox'), 'a')

//Step - 2 Wait for auto suggestion list 
WebUI.waitForElementPresent(findTestObject('Object Repository/TelerikWebElemet/Janet'), GlobalVariable.TimeOut)

//Step - 3 Select the option
WebUI.click(findTestObject('Object Repository/TelerikWebElemet/Janet'))
