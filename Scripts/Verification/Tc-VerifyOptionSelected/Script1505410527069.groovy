...
WebUI.selectOptionByValue(findTestObject('Bugzilla/EnterBugDetailScreen/Component'), 'Logging and results', false)

WebUI.verifyOptionSelectedByIndex(findTestObject('Bugzilla/EnterBugDetailScreen/Component'), 2, 1)
