...
not_run: WebUI.openBrowser('https://www.w3schools.com/js/js_popup.asp')

not_run: WebUI.waitForPageLoad(GlobalVariable.TimeOut)

not_run: WebUI.maximizeWindow()

//WebUI.scrollToElement(findTestObject('Object Repository/W3School/TryItBtn'), GlobalVariable.TimeOut)
...
WebUI.click(findTestObject('Object Repository/W3School/TryButton'))
